<section class="sobre">
    <div class="linha">
        <div class="esquerda">
            ...
            <p class="texto">
                Cuidadosamente planejado em uma área de mais de 130 mil m², com exuberantes jardins de inspiração oriental, proporciona o clima de paz e tranquilidade ideal para fugir do stress da vida moderna.<br />
